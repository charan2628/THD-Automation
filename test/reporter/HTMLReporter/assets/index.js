...
/* harmony import */ var _style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style */ "./style.js");
...
Object(_style__WEBPACK_IMPORTED_MODULE_3__["default"])();
...
function style() {
  var steps = document.querySelectorAll('li.step.passed');
  steps.forEach(function (step) {
    var passed = document.createElement('i');
    passed.innerHTML = "&nbsp;";
  ...
  steps.forEach(function (step) {
    var failed = document.createElement('i');
    failed.innerHTML = "&nbsp;&nbsp;";
